  ...
  return (
    <section id="About" className=" md:px-6 text-center " >
      ...
      md:text-left md:leading-5">
        ...
        <span className="text-black font-bold" > a year of experience</span> building 
        <span className="text-blue-00 font-bold" > responsive web apps</span> using 
        <span className="text-blue-700 font-bold" > frontend technology. </span> 
        I have received sunstantial and comprehensive knowledge  
        ...
        <span className="text-blue-00 font-bold" > accessibility</span>, 
        <span className="text-red-00 font-bold" > games </span> and 
